<?php
/* Smarty version 4.3.4, created on 2023-12-06 20:15:24
  from 'c:\xampp\htdocs\tpl\template\index\job_list.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_657065dc0d0b99_63177921',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4efef69aa6fe820d19be73d8ceb8d65b23307313' => 
    array (
      0 => 'c:\\xampp\\htdocs\\tpl\\template\\index\\job_list.tpl',
      1 => 1701864919,
      2 => 'file',
    ),
  ),
...
function content_657065dc0d0b99_63177921 (Smarty_Internal_Template $_smarty_tpl) {
?><body class="bg-wight">
...
/index/index">首頁</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">工作列表</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
>
                                                            <span><img src="/assets/images/icon/apply-ellipse.svg"
                                                                    alt=""></span> 立即申請
                                                        </a>
                                                    </div>
                                                </div>
...
>
                    $(document).ready(function() {
                        $("a.custom-link").click(function(event) {
                            ...
                            var valueToSend = $(this).attr("id");
                            $.get("apply", { id: valueToSend }, function(data, status) {
                                alert("数据: " + data + "\n状态: " + status);
                            });
                        });
                    });
